...
*/
    ...
    public function GameBet(Request $request) {
        ...
        // 主隊
        $return = LsportTeam::where("team_id",$home_id)->first();
        if ($return === false) {
                $this->ApiError("11");
        }
        //////////////////////////////////////////
        ...
        $order['home_team_name'] = $return[$name_columns];
        //////////////////////////////////////////
        
        // 客隊
        $return = LsportTeam::where("team_id",$away_id)->first();
        if ($return === false) {
                $this->ApiError("11");
        }
    ...
    public function ResultIndex(Request $request) {
        ...
        /////////////////////////
        // 取得比賽資料
        $return = LsportFixture::whereIn("status",[3,4,5,6,7,8])->where("sport_id",$sport_id)->orderBy("start_time","DESC")->get();
        if ($return === false) {
            $this->ApiError('02');
        }
...
****************************************/
    ...
    // public function GameIndexOld(Request $request) {
