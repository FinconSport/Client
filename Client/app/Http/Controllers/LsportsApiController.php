...
class LsportsApiController extends Controller {
     ...
     * index
     *
     * @param p1 - Request $request: 前端傳入的使用者請求。User requests passed in by the front-end.
     ...
     *
    * @param p1 - Request $request: 前端傳入的使用者請求，必須包含player代表玩家的ID。User requests passed in by the front-end. Key 'player' is essential, which represents the player ID.
