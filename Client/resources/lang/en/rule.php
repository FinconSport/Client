...
return [
	...
	"ruleTitles" => [
		...
		"inplay_handicap" => "Inplay Handicap", // "滾球讓球",
		"total_score" => "Total Points: Over / Under", // "總得分: 大 / 小",
		"rolling_total_score" => "Inplay Total Points: Over / Under", // "滾球總得分: 大 / 小",
		"rolling_ball_total" => "Inplay Total Score: Over / Under", //"滾球總分： 大 / 小",
		...
		"rolling_ball_overUnder" => "Inplay Over / Under", // "滾球大小盤",
		...
		"example_1" => "Example 1: When the game score is Arsenal 1-0 Manchester United, members bet on the Inplay moneyline - Arsenal wins.", // "範例1：在賽事比分為阿森納1-0曼聯時，會員投注滾球獨贏盤 – 阿森納贏",
		"example_2" => "Example 2: When the game score is Arsenal 1-0 Manchester United, members bet on the Inplay moneyline - Manchester United wins.", // "範例2：在賽事比分為阿森納1-0曼聯時，會員投注滾球獨贏盤 –曼聯贏：",
	...
	"generalRulesSoccor" => [
		...
		"gr_soccor_3" => "Unless otherwise specified in individual play rules, the settlement of all Inplay bets will be based on the 90-minute result.",
	...
	"ruleContentsSoccor" => [
		...
		"rc_soccor_49" => "Predict which team will win in Inplay betting.",
		...
		"rc_soccor_51" => "Here are examples of Inplay match winner bets.",
