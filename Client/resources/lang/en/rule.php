...
return [
	...
	"ruleContentsBasketball" => [
		"moneyline_1" => "Predict which team will win the game. The handicap provides two teams as betting options.",
		// "moneyline_1" => "預測哪一支球隊將在比賽勝出。盤口提供兩支球隊為投注選項。",
		"moneyline_2" => "Event handicaps include full-game, half-game, or single-quarter bets.",
		// "moneyline_2" => "賽事盤口包括全場、半場或單節投注。",

		"getTheBall_1" => "Predict which team, according to the handicap specified, will win the game in half-time/full-time/single quarter.",
		// "getTheBall_1" => "預測哪一支球隊在盤口指定的讓分球數在半場/全場/賽事單節贏得比賽。",
		"getTheBall_2" => "If the event is canceled or interrupted in the second half, all first-half bets remain valid.",
		// "getTheBall_2" => "如果賽事在下半場取消或中斷，所有上半場注單保持有效。",
		"getTheBall_3" => "If the event is canceled or interrupted in the second half, all second-half bets will be considered invalid.",
		// "getTheBall_3" => "如果賽事在下半場取消或中斷，所有下半場注單將被視為無效。",
		"getTheBall_4" => "Event handicaps include full-game, half-game, or single-quarter bets.",
		// "getTheBall_4" => "賽事盤口包括全場、半場或單節投注。",

		"inplayHandicap_1" => "Predict which team, according to the specified handicap, will win in the half-time/full-time/single quarter of the game.",
		// "inplayHandicap_1" => "預測哪一支球隊在盤口指定的讓分數裏贏得半場/全場/賽事單節的比賽。",
		"inplayHandicap_2" => "Event handicaps include full-game, half-game, or single-quarter bets.",
		// "inplayHandicap2" => "賽事盤口包括全場、半場或單節投注。",

		"totalScore_1" => "Predict whether the total score of the game will be greater or less than the specified over/under score in the handicap.",
		// "totalScore_1" => "預測賽事總比分將大於或小於在盤口指定的大/小盤分數。",
		"totalScore_2" => "Event handicaps include full-game, half-game, or single-quarter bets.",
		// "totalScore_2" => "賽事盤口包括全場、半場或單節投注。",
		"totalScore_3" => "If the event is interrupted, over/under bets will only be settled for bets where future scores will not affect the outcome. In any other case, the bets will be considered invalid.",
		// "totalScore_3" => "如果賽事中斷，大/小盤將僅會結算任何將來的得分不會影響到賽果的注單。若遇到任何其它情況，注單將一律被視為無效。",
		"totalScore_4" => "If the event is interrupted in the first half, all first-half bets will be canceled unless there is a clear result before the interruption, and there is no significant impact on the outcome of the event.",
		// "totalScore_4" => "如果賽事在上半場中斷，所有上半場注單將被取消，除非中斷前已有明確結果並且之後沒有任何顯著會影響賽事結果的情況注單才會被結算。",
		"totalScore_5" => "If the event is canceled or interrupted in the second half, all first-half bets remain valid.",
		// "totalScore_5" => "如果賽事在下半場取消或中斷，所有上半場注單保持有效。",
		"totalScore_6" => "If the event is canceled or interrupted in the second half, all second-half bets will be canceled unless there is a clear result before the interruption, and there is no significant impact on the outcome of the event.",
		// "totalScore_6" => "如果賽事在下半場取消或中斷，所有下半場注單將被取消，除非中斷前已有明確結果並且之後沒有任何顯著會影響賽事結果的情況注單才會被結算。",
		"totalScore_7" => "If the event is interrupted, all period bets will be canceled unless one of the following conditions is met:",
		// "totalScore_7" => "如果賽事中斷, 所有時節的注單將被取消除非遇到以下其中一個情況：",
		"totalScore_7_1" => "The period bet is placed before the interruption.",
		// "totalScore_7_1" => "投注的時節是在比賽中斷前。",
		"totalScore_7_2" => "There is a clear result before the interruption, and there is no significant impact on the outcome of the event.",
		// "totalScore_7_2" => "比賽中斷前已有明確結果並且之後沒有任何顯著會影響賽事結果的情況。",

		"rollingTotalScore_1" => "Predict whether the total score of the game will be greater or less than the specified over/under score in the handicap.",
		// "rollingTotalScore_1" => "預測賽事總比分將大於或小於在盤口指定的大/小盤分數。",
		"rollingTotalScore_2" => "Settlement is based on the handicap score set at 0-0 at the end of the game/period.",
		// "rollingTotalScore_2" => "結算是以0-0的比分在比賽/時節結束後按盤口開出的讓分數做裁決。",
		"rollingTotalScore_3" => "If the event is interrupted, over/under bets will only be settled for bets where future scores will not affect the outcome. In any other case, the bets will be considered invalid.",
		// "rollingTotalScore_3" => "如果賽事中斷，大/小盤將僅會結算任何將來的得分不會影響到賽果的注單。若遇到任何其它情況，注單將一律被視為無效。",

		"teamScores_1" => "Predict whether the total score of the home/away team in the game will be greater or less than the specified over/under score in the handicap.",
		// "teamScores_1" => "預測賽事主隊/客隊的總分數將大於或小於在盤口指定的大/小盤分數。",
		"teamScores_2" => "If the event is canceled, all bets will be considered invalid unless the bets have been settled before the interruption or there is a clear result before the interruption, and there is no significant impact on the outcome of the event.",
		// "teamScores_2" => "如果賽事取消，所有的注單將會被認為無效，除非注單在中斷前已經結算或者在中斷前已有明確的結果並且之後沒有任何顯著會影響賽事結果的情況注單才會被結算。",
		"teamScores_3" => "Settlement for all bets is based on official statistics from relevant sports organizations.",
		// "teamScores_3" => "所有注單的結算都是依據相關體育機構的官方統計數據為準。",

		"totalPoints_1" => "Predict whether the total score of the game will be an odd or even number.",
		// "totalPoints_1" => "預測賽事的總比分是單數或雙數。",
		"totalPoints_2" => "Event handicaps include full-game, half-game, or single-quarter bets.",
