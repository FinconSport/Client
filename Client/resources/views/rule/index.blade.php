                                                ...
                                                <ul class="roman-bullets">
                                                    @foreach($grRule as $subKey => $subRule)
                                                        @if (is_array($subRule))
                                                            <ul class="roman-bullets">
                                                                @foreach($subRule as $subSubKey => $subSubRule)
                                                                    <li class="1">{{ trans('rule.ruleContentsSoccor.rc_soccor_28_0.' . $key . '.' . $subKey . '.' . $subSubKey) }}</li>
                                                                @endforeach
                                                            </ul>
                                                        @else
                                                            <li class="2">{{ trans('rule.ruleContentsSoccor.rc_soccor_28_0.' . $key . '.' . $subKey) }}</li>
                                                        @endif
                                                    @endforeach
                                                </ul>
                                            @else
                                                <li class="3">{{ trans('rule.ruleContentsSoccor.rc_soccor_28_0.' . $key) }}: {{ $grRule }}</li>
                                            @endif
                                        @endforeach
                                    </ul>
                                </ul>
