...
<script>
    ...
    function createMarketRateContainer(v, k2, v2) {
        ...
        if (createdElementKeys.has(marketBetRateId)) {
            updateExistingElement(v, v2, marketBetRateId);
            console.log('created')
        } else {
            createNewElement(v, v2, marketBetRateId);
            console.log('existing')
        }
    }

    function createNewElement(v, v2, marketBetRateId) {
    ...
    function updateExistingElement(v, v2, marketBetRateId) {
        marketBetRateTemp.find('.odd').text(v2.price)
        if( betData > 0 ) {
            switch (v.priority) {
                case 3: case 203: case 204: case 103: case 104: case 110: case 114: case 118: case 122:
