...
<script>
    ...
    function createMarketContainer(k, v) {
        ...
        if (!$('#' + v.market_id).length) {
            ...
            var translatedTitle = @json(trans(transKey));
            marketNameElement.html(
            `<i class="fa-sharp fa-solid fa-star" style="color: #415a5b; margin-right: 0.5rem;"></i> @lang(trans(transKey))`);
