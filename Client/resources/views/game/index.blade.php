...
<script>
    ...
    function isBaseball_createScoreBoardTemplate_lessthansix(sport, data, baseballShowStage_lts) {
        const livingContainerTemp_lts = $(`div[template="isBaseball_livingConTemplate_lessThanSix"]`).clone();
        ...
        const mainCon_lts = data.list.fixture_id + '_' + randomInt_lts + '_lts'; 
