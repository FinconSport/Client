...
<script>
    ...
    function createMarketContainer(k, v) {
        ...
        if (!$('#' + v.market_id).length) {
            ...
            marketNameElement.html(`<i class="fa-sharp fa-solid fa-star" style="color: #415a5b; margin-right: 0.5rem;"></i>{{ trans('game.game_priority.${matchListD.data.series.sport_id}.${v.priority}') }}`);
