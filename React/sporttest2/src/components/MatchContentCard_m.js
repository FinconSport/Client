...
class MatchContentCard extends React.Component {
	...
	render() {
        ...
        const selectedM = this.props.selectedM
                                                                            ...
                                                                            if( sport === 1 ) {
                                                                                return(
                                                                                    <SliderBrickHeight3 key={index} onClick={()=>this.getBetData(
                                                                                        ...
                                                                                        <div className="w-100 h-100" bet_match={v.match_id} bet_type={filteredData.rate_id} bet_type_item={targetRate.id} style={selectedM !== undefined && selectedM.bet_match === v.match_id && selectedM.bet_type === filteredData.rate_id && selectedM.bet_type_item === targetRate.id ? selectedOn : null }>
                                                                                                    ...
                                                                                                    return(
                                                                                                        <div style={OtherBetBrick} key={v3.id} onClick={()=>this.getBetData(v.match_id, ele.rate_id, v3.id, v3.rate, ele.name, v3.name, v.series.name, 
                                                                                                            ...
                                                                                                            v.start_time
                                                                                                                ...
                                                                                                                <div className="w-100 h-100" bet_match={v.match_id} bet_type={ele.rate_id} bet_type_item={v3.id} style={selectedM !== undefined && selectedM.bet_match === v.match_id && selectedM.bet_type === ele.rate_id && selectedM.bet_type_item === v3.id ? selectedOn : null }>
                                                                                        ...
                                                                                        <div className="col-6" key={k2}>
                                                                                            <div style={OtherBetBrick} key={v2.id} onClick={()=>this.getBetData(v.match_id, ele.rate_id, v2.id, v2.rate, ele.name, v2.name, v.series.name, 
                                                                                                ...
                                                                                                v.start_time
                                                                                                    ...
                                                                                                    <div className="w-100 h-100" bet_match={v.match_id} bet_type={ele.rate_id} bet_type_item={v2.id} style={selectedM !== undefined && selectedM.bet_match === v.match_id && selectedM.bet_type === ele.rate_id && selectedM.bet_type_item === v2.id ? selectedOn : null }>
